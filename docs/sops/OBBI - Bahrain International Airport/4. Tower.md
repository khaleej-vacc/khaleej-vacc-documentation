...
slug: OBBITWR
---
The section outlines the Standard Operating Procedures for all Aerodrome operations conducted at Bahrain International Airport (OBBI).
...
The preferred runway configuration is departing and arriving runway 30R, which shall be used up to a 5-knot tailwind. Otherwise, runway 12L will be used. Tower controllers must utilise the METAR/TAF and real-life runway configurations to judge which runway they should operate on. 
...
**Example:**
>"GFA8KC, after departue fly heading 345 degrees, winds 280 degrees at 4 knots runway 30R, cleared for take-off."
...
#### General
Although radar controllers are responsible for separating arriving aircraft, the TWR controller shall still ensure that the seperation is maintained, ideally 4NM with a minimum of 2.5NM until the preceding aircraft crosses the runway threshold.

#### Speed control
If it is apparent that minimum separation may not exist, TWR may use a tactical reduction in aircraft speed. Approach/CTR may assign speeds when traffic are established on the localiser, such at 180kts till 10DME / 160 till 4DME. Tower controllers **CANNOT** assign speeds on the localiser.
...
Once the aircraft has acknowledged the instruction and is observed to be climbing, they shall be handed off to Bahrain Approach 127.850.

**Example:**
>"UAE175, follow standard missed approach procedure, contact Bahrain Approach 127.850."
...
Arriving aircraft may exit the RWY to the south at TWY A4 or beyond or,

Arriving aircraft may exit the RWY to the north at TWY B1 or TWY B2.

**Runway 12L:**

Arriving aircraft may exit the RWY to the south at TWY A5 or beyond or,
